...
final class AlertViewController: UIViewController {
    ...
    required init?(coder: NSCoder) {
        ...
        self.tableView = ProjectTableView(for: .todo, to: ProjectTableViewModel(dataManager: LocalDataManager()))
        self.alertViewModel = AlertViewModel(dataManager: LocalDataManager())
